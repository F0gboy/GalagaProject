...
class Player(Components, ABC):
    ...
    def awake(self, game_world):
        ...
        # Manually adjust collider bounds (customize these offsets and dimensions as needed)
        custom_rect = sr._sprite.rect.copy()
        custom_rect.x += 5   # offset to the right
        custom_rect.width = 100  # custom width
        custom_rect.height = 50  # custom height
        collider._custom_rect = custom_rect
