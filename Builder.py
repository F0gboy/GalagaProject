...
from component import Animator, SpriteRenderer, Collider, Button
...
class PlayerBuilder(Builder):
    def build(self):
        ...
        sprite_renderer.resize(20, 20)  # Resize player sprite
        
        collider = self._gameObject.add_component(Collider())  # Add Collider component
        collider.set_size(20, 20)  # Resize collider to match sprite size
